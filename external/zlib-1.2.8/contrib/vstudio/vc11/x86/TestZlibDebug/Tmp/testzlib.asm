; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.30219.0 
	...
	TITLE	F:\bitbucket\gamegui\external\zlib-1.2.8\contrib\testzlib\testzlib.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
$SG87041 DB	'defcpr time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG87042 DB	'defcpr result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG87053 DB	'1.2.8', 00H
	ORG $+2
$SG87058 DB	'total uncompress size = %u, in %u step', 0aH, 00H
$SG87060 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG87062 DB	'uncpr  time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG87063 DB	'uncpr  result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG87066 DB	'compare ok', 0aH, 00H
$SG86983 DB	'rb', 00H
	ORG $+1
$SG87016 DB	'error reading %s', 0aH, 00H
	ORG $+2
$SG87014 DB	'run TestZlib <File> [BlockSizeCompress] [BlockSizeUncomp'
	DB	'ress] [compres. level]', 0aH, 00H
$SG87018 DB	'file %s read, %u bytes', 0aH, 00H
$SG87032 DB	'1.2.8', 00H
	ORG $+2
$SG87037 DB	'total compress size = %u, in %u step', 0aH, 00H
	ORG $+2
$SG87039 DB	'time = %u msec = %f sec', 0aH, 00H
_DATA	ENDS
...
; File f:\bitbucket\gamegui\external\zlib-1.2.8\contrib\testzlib\testzlib.c
_TEXT	SEGMENT
_zcpr$1 = -260						; size = 56
_zcpr$2 = -204						; size = 56
...
; 919  :     __asm    {
; 920  :         mov     ecx, ShiftCount

	mov	ecx, DWORD PTR _ShiftCount$[ebp]

; 921  :         mov     eax, dword ptr [Value]

	mov	eax, DWORD PTR _Value$[ebp]

; 922  :         mov     edx, dword ptr [Value+4]
