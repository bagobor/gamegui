; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.30219.0 
	...
	TITLE	F:\bitbucket\gamegui\external\zlib-1.2.8\inflate.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG86017 DB	'invalid distances set', 00H
	ORG $+2
$SG86066 DB	'invalid literal/length code', 00H
$SG86121 DB	'invalid distance code', 00H
	ORG $+2
$SG86149 DB	'invalid distance too far back', 00H
	ORG $+2
$SG86179 DB	'incorrect data check', 00H
	ORG $+3
$SG86199 DB	'incorrect length check', 00H
	ORG $+1
$SG85446 DB	'1.2.8', 00H
	ORG $+2
$SG85569 DB	'incorrect header check', 00H
	ORG $+1
$SG85573 DB	'unknown compression method', 00H
	ORG $+1
$SG85583 DB	'invalid window size', 00H
$SG85603 DB	'unknown compression method', 00H
	ORG $+1
$SG85606 DB	'unknown header flags set', 00H
	ORG $+3
$SG85745 DB	'header crc mismatch', 00H
$SG85812 DB	'invalid block type', 00H
	ORG $+1
$SG85835 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG85878 DB	'too many length or distance symbols', 00H
$SG85907 DB	'invalid code lengths set', 00H
	ORG $+3
$SG85948 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG86001 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG86009 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG86013 DB	'invalid literal/lengths set', 00H
_DATA	ENDS
PUBLIC	_inflate@8
...
; File f:\bitbucket\gamegui\external\zlib-1.2.8\inflate.c
_TEXT	SEGMENT
tv70 = -12						; size = 4
_next$ = -8						; size = 4
_got$ = -4						; size = 4
...
; 190  :         stream_size != (int)(sizeof(z_stream)))
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG85446[edx]
	cmp	eax, ecx
...
; 662  :                 strm->msg = (char *)"incorrect header check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG85569
...
; 667  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG85573
...
; 676  :                 strm->msg = (char *)"invalid window size";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85583
...
; 691  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG85603
...
; 696  :                 strm->msg = (char *)"unknown header flags set";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85606
...
; 800  :                     strm->msg = (char *)"header crc mismatch";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG85745
...
; 859  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85812
...
; 868  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85835
...
; 907  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85878
...
; 929  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG85907
...
; 952  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85948
...
; 975  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86001
...
; 989  :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86009
...
; 1003 :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86013
...
; 1012 :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86017
...
; 1064 :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG86066
...
; 1100 :                 strm->msg = (char *)"invalid distance code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG86121
...
; 1130 :                         strm->msg = (char *)"invalid distance too far back";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG86149
...
; 1189 :                     strm->msg = (char *)"incorrect data check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG86179
...
; 1202 :                     strm->msg = (char *)"incorrect length check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86199
