; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.30219.0 
	...
	TITLE	F:\bitbucket\gamegui\external\zlib-1.2.8\infback.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG85399 DB	'1.2.8', 00H
	ORG $+2
$SG85488 DB	'invalid block type', 00H
	ORG $+1
$SG85515 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG85570 DB	'too many length or distance symbols', 00H
$SG85602 DB	'invalid code lengths set', 00H
	ORG $+3
$SG85650 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG85712 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG85720 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG85724 DB	'invalid literal/lengths set', 00H
$SG85728 DB	'invalid distances set', 00H
	ORG $+2
$SG85788 DB	'invalid literal/length code', 00H
$SG85853 DB	'invalid distance code', 00H
	ORG $+2
$SG85880 DB	'invalid distance too far back', 00H
_DATA	ENDS
...
; File f:\bitbucket\gamegui\external\zlib-1.2.8\infback.c
_TEXT	SEGMENT
_state$ = 8						; size = 4
_fixedtables PROC
...
; 38   :         stream_size != (int)(sizeof(z_stream)))
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG85399[edx]
	cmp	eax, ecx
...
; 320  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85488
...
; 331  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85515
...
; 369  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85570
...
; 391  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG85602
...
; 414  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85650
...
; 437  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85712
...
; 451  :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85720
...
; 465  :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG85724
...
; 474  :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG85728
...
; 532  :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85788
...
; 579  :                 strm->msg = (char *)"invalid distance too far back";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG85880
