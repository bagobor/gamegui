...
void System::makeLuaBinding(void)
{
	...
	module(m_scriptSys.getLuaState())
		[
			...
			.property("cursor", &System::getCursor)
			...
			.def("loadXml", (WindowBase*(System::*)(const std::string&))&System::loadXml)
			.def("loadWindow", (WindowBase*(System::*)(WindowBase&, const std::string&))&System::loadXml)
			.def("queryCaptureInput", &System::queryCaptureInput)
			.def("getTargetWindow", &System::getTargetWindow)
			.def("setShowCursor", &System::setShowCursor)
			,
			class_ <Cursor>("Cursor")
			.property("type", &Cursor::getType, &Cursor::setType)
			.property("position", &Cursor::getPosition, &Cursor::setPosition)
			.property("visible", &Cursor::isVisible, &Cursor::setVisible)
			.def("hide", &Cursor::hide)
			.def("show", &Cursor::show)
			,
			class_ <Rect>("Rect")
			.def(constructor<>())
			...
			.enum_("ImageOps")
			[
				value("Stretch", ImageOps::Stretch),
				value("Tile", ImageOps::Tile)
			]
			...
			,
			class_<ScriptObject<WindowBase>, ScriptObjectBase, luabind::wrap_base>("ScriptObjectBaseWindow")
			,
			class_ <WindowBase, ScriptObject<WindowBase>, luabind::wrap_base >("BaseWindow")
			.property("parent", (WindowBase* (WindowBase::*)() const)&WindowBase::getParentConst)			
			.property("area", &WindowBase::getArea, &WindowBase::setArea)			
			.property("type", &WindowBase::getType)
			.property("visible", &WindowBase::getVisible, &WindowBase::setVisible)
			.property("enabled", &WindowBase::getEnabled, &WindowBase::setEnabled)
			.property("backcolor", &WindowBase::getBackColor, &WindowBase::setBackColor)
			.property("forecolor", &WindowBase::getForeColor, &WindowBase::setForeColor)
			.property("tag", &WindowBase::getUserData, &WindowBase::setUserData)
			.property("alwaysOnTop", &WindowBase::getAlwaysOnTop, &WindowBase::setAlwaysOnTop)
			.property("draggable", &WindowBase::isDraggable, &WindowBase::setDraggable)
			.property("acceptDrop", &WindowBase::isAcceptDrop, &WindowBase::setAcceptDrop)
			.property("disableRise", &WindowBase::getDisableRise, &WindowBase::setDisableRise)
			.property("name", &WindowBase::getName, &WindowBase::setName)
			.def("getName", &WindowBase::getName)
			.def("setName", &WindowBase::setName)
			.def("getType", &WindowBase::getType)
			.def("setArea", &WindowBase::setArea)
			.def("getArea", &WindowBase::getArea)
			.def("isCursorInside", &WindowBase::isCursorInside)
			.def("hitTest", &WindowBase::hitTest)
			.def("setVisible", &WindowBase::setVisible)
			.def("getVisible", &WindowBase::getVisible)
			.def("setEnabled", &WindowBase::setEnabled)
			.def("getEnabled", &WindowBase::getEnabled)
			.def("setBackColor", &WindowBase::setBackColor)
			.def("getBackColor", &WindowBase::getBackColor)			
			.def("setForeColor", &WindowBase::setForeColor)
			.def("getForeColor", &WindowBase::getForeColor)			
			.def("setUserData", &WindowBase::setUserData)
			.def("getUserData", &WindowBase::getUserData)
			.def("moveToFront", (void(WindowBase::*)(void))&WindowBase::moveToFront)
			.def("bringToBack", (void(WindowBase::*)(void))&WindowBase::bringToBack)			
			.def("setAlwaysOnTop", &WindowBase::setAlwaysOnTop)
			.def("getAlwaysOnTop", &WindowBase::getAlwaysOnTop)
			.def("enableTooltip", &WindowBase::enableTooltip)
			.def("hasTooltip", &WindowBase::hasTooltip)
			.def("find", &WindowBase::findChildWindow)
			.def("suspendLayout", &WindowBase::suspendLayout)
			.def("resumeLayout", &WindowBase::resumeLayout)
			.def("addChild", &WindowBase::addChildWindow)
			.def("setInputFocus", &WindowBase::setInputFocus)
			.def("resetInputFocus", &WindowBase::resetInputFocus)
			.def("hasInputFocus", &WindowBase::hasInputFocus)
			.def("setIgnoreInputEvents", &WindowBase::setIgnoreInputEvents)
			.def("subscribe", &WindowBase::subscribeNamedEvent)
			.def("unsubscribe", &WindowBase::unsubscribeNamedEvent)
			.def("send", &WindowBase::sendNamedEvent)
			.def("addScriptEventHandler", &WindowBase::addScriptEventHandler)
			.def("startTick", &WindowBase::startTick)
			.def("stopTick", &WindowBase::stopTick)
			.def("transformToWndCoord", &WindowBase::transformToWndCoord)
			.def("transformToRootCoord", &WindowBase::transformToRootCoord)
			,
			...
			,
			class_ <Tooltip, bases<WindowBase> >("Tooltip")
			.property("fadein", &Tooltip::getFadeIn, &Tooltip::setFadeIn)
			.property("fadeout", &Tooltip::getFadeOut, &Tooltip::setFadeOut)
			,
			class_ <DragContainer, bases<WindowBase> >("DragContainer")
			,
			class_ <Label, bases<WindowBase> >("StaticText")
			...
			,
			class_ <ImageBox, bases<WindowBase> >("ImageBox")
			...
			,
			class_ <Panel, bases<WindowBase> >("Panel")
			,
			...
			class_ <Slider, bases<WindowBase> >("Slider")
			...
			,
			class_ <ScrollPane, bases<WindowBase> >("ScrollPane")
			.def("setTarget", &ScrollPane::setTarget)
			,
			class_ <BaseList, bases<WindowBase> >("BaseList")
